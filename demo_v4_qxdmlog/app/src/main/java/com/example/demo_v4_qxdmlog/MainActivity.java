...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView textview_cmd_current;  // save set cmd
    private EditText textview_cmd_send;  // save set cmd
...
//        ball.requestLayout();
    ...
    private void startQxdmRecording(){
        ...
        String tempcmd = null;
        cmdBuf1.append("diag_mdlog -f /sdcard/default_V2.6_auddsp_btfmwlan_ril1.cfg");
